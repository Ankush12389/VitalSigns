...
public class RatesActivity extends ActionBarActivity {
    ...
    private static long startTimeActivity = 0;
    private static long endTimeActivity = 0;

    public String safeGet( TextView tv ) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textVhr = ((TextView) findViewById(R.id.hr));
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                endTimeActivity = System.currentTimeMillis();
                double rr = 600000.0/( endTimeActivity - startTimeActivity );
        ...
        text = (TextView) findViewById(R.id.hr);
